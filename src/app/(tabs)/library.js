...
import { View, Text, TextInput, StyleSheet, Platform, Alert, Share, Pressable } from 'react-native';
import * as DocumentPicker from 'expo-document-picker';
import { Ionicons } from '@expo/vector-icons';
import {
  Screen, PageHeader, Card, Button, Chip, IconBtn, Sheet, Field, ChipSelect,
  T, EmptyState, Divider,
} from '../../components/ui';
import { useData } from '../../lib/store';
import { saveFile, openFile, deleteFile } from '../../lib/files';
import { colors, fonts, DOC_CATEGORIES, categoryMeta } from '../../lib/theme';
import { uid, formatShort } from '../../lib/dates';
